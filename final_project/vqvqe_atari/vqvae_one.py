...
#
# ====================================
# Code originally borrowed from https://github.com/deepmind/sonnet
# and ported it to PyTorch
#
# I borrowed the pytorch code from
...
class VQVAE(nn.Module):
    ...
    def encode(self, input):
        ...
        """
        # Encode input image to lower-D latent space
        enc_b = self.enc_b(input)
        ...
        """
        # Quantize each "pixel" of latent space
